getplotdata <- function(date1="01/02/2007",date2="02/02/2007",color="Red")
 ...
 ##plot(4:4,xaxt="n",yaxt="n",xlab="",ylab="")
 ...
 legend("topright", c("Sub_metering_1","Sub_metering_2", "Sub_metering_3"), lty = c(1,1, 1),col = c("Black","Red","Blue"),cex=.6)


 plot(dateTime, dataset$Global_reactive_power, type="l", ylab="Global_reactive_power",xlab="datetime")
